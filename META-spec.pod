...
A I<List> is an ordered list of one or more data elements.  Elements of
...
A I<Map> is an unordered collection of one or more data elements
...
Identifier.  (It is called URL and not URI for historical reasons.)
