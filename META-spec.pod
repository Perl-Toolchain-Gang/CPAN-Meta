...
C<recommends> and the value provides a set of prerequisite relations
that relate package names to I<Version Ranges>.  

The set of relations may be specified either as a Map of unordered
relations, or as an ordered List of package name and Version Range
pairs.  Consider the following examples:
...
which allows hand-optimization in some cases.  Consumers should respect
an ordered set of relationships unless there are particular reasons for
