...
(Spec 1.0) [optional] {hashref} A hashref indicating the Perl
...
I<(Spec 1.1) [optional] {hashref} A hashref of names for optional features
...
(Spec 1.4) [optional] {hashref} A hashref indicating the Perl prerequisites
...
(Spec 1.0) [optional] {hashref} A hashref indicating any items that
