...
The C<prereqs> key and data structures within the C<optional_features>
key use prerequisite specification structures.  These entries in the
metadata structure define the relationship between this distribution
and other packages.  The prereq spec structure is a hierarchical data
