...
or in which the definition was modified, whether the key is 'required'
or 'optional' and the data type of the corresponding data element.
...
(Spec 1.0) [required] {string} The name of the distribution.  This is often
created by taking the "main module" in the distribution and changing
"::" to "-", but the name may be completely unrelated to the modules
within the distribution.  C.f. L<http://search.cpan.org/dist/libwww-perl/>.
...
L</"bugtracker">.  The addressee(s) can be contacted for any purpose
